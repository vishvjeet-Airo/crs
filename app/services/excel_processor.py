...
#         # Collect dropdown (data validation) info
#         dropdowns = {}
#         if sheet.data_validations:
#             for dv in sheet.data_validations.dataValidation:
#                 if dv.formula1:
#                     # Store the dropdown rule
#                     for ref in dv.sqref:
#                         dropdowns[str(ref)] = dv.formula1
...
#                 # Check if cell is part of dropdown
#                 for ref, formula in dropdowns.items():
#                     if cell.coordinate in ref:
#                         if formula.startswith("{"):  
#                             # Case: Explicit list of values e.g. {"Yes","No","Maybe"}
#                             dropdown_options = formula.strip("{}").split(",")
#                             dropdown_options = [opt.strip('"') for opt in dropdown_options]
#                         else:
#                             # Case: Range reference e.g. A1:A3
#                             try:
...
#                             except Exception:
#                                 dropdown_options = [formula]  # fallback
...
#     print("Processed Excel → JSON saved as processed.json")
